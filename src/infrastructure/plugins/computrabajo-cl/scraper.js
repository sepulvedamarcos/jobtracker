...
var BASE_URL = "https://www.computrabajo.cl";
...
async function scan(input) {
  ...
  try {
    for (let i = 0; i < keywords.length; i++) {
      ...
      try {
        const normalizedKeyword = keyword.toLowerCase().trim().replace(/\.js\b/gi, "javascript").replace(/\.net\b/gi, "dotnet").replace(/\.ts\b/gi, "typescript");
