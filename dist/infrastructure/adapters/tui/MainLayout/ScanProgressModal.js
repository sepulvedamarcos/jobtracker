...
export const ScanProgressModal = ({ isActive, keywords, plugins, currentPlugin, currentKeyword, message, progress, width, height, pluginResults = [], }) => {
    if (!isActive)
        return null;
